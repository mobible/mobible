...
var MobibleSMSMenu = function () {
  ...
  self.add_state(new ChoiceState(
    ...
    'Welcome to Mobible!', [
      new Choice('invite', 'Invite someone to your Mobible group.'),
      new Choice('share', 'Share a verse with your Mobible group.'),
      new Choice('instructions', 'Receive instructions for u & ur friends.')
    ]
  ));
};
